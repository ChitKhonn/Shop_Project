            ...
            @if ($product->count() > 0)
                @foreach ($product as $rs)
                    <tr>
                        <td class="align-middle">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="{{ route('products.show', $rs->id) }}" type="button"
                                    class="btn"><svg xmlns="http://www.w3.org/2000/svg" height="1em" class="detail"
                                        viewBox="0 0 512 512">
                                        <style>
                                            .detail {
                                                fill: #7c8383
                                ...
                                <a href="{{ route('products.edit', $rs->id) }}" type="button" class="btn"><svg
                        ...
                        <td class="align-middle">{{ $rs->owner_name }}</td>
